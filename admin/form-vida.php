                ...
                <div class="col-md-12 col-md-offset-0">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-md-offset-0">
                            ...
                            <input type="hidden" name="number_form" value="">
                                ...
                                <div class="main_table">
                                    ...
                                    <tbody>
                                        ...
                                        <td width="29%"><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="Mentales" class="enf_1" name="enferm[]" value="mental_psiqui"/>
                                        ...
                                        <td width="24%"><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="Gastrointestinales" class="enf_2" name="enferm[]" value="grastroint"/>
                                        ...
                                        <td width="26%"><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="Drogadiccion" class="enf_3" name="enferm[]" value="drogadiccion"/>
                                        ...
                                        <td><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="Tabaquismo" class="enf_4" name="enferm[]" value="tabaquismo"/>
                                        ...
                                        <td width="2%"><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="Alcoholismo" class="enf_5" name="enferm[]" value="alcoholismo"/>
                                        ...
                                        <td><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="Cardiovasculares" class="enf_6" name="enferm[]" value="cardiovascu"/>
                                        ...
                                        <td><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="Cerebrovasculares" class="enf_7" name="enferm[]" value="cerebrovascu"/>
                                        ...
                                        <td><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="Hipertension" class="enf_8" name="enferm[]" value="hipertension"/>
                                        ...
                                        <td>Cigarrillos Diarios
                                            ...
                                            <input type="checkbox" id="menos" class="enf_9" name="enferm[]" value="cincomenoscigarrillo"/>
                                        ...
                                        <td> Tragos Semanales
                                            ...
                                            <input type="checkbox" id="menos-alc" class="enf_10" name="enferm[]" value="cincomenosalc"/>
                                        ...
                                        <td><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="Pulmonares" class="enf_11" name="enferm[]" value="pulmonares"/>
                                        ...
                                        <td><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="Artritis" class="enf_12" name="enferm[]" value="artritis"/>
                                        ...
                                        <td><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="Cancer" class="enf_13" name="enferm[]" value="cancer"/>
                                        ...
                                        <td><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="mas" class="enf_14" name="enferm[]" value="veinteunomascig"/>
                                        ...
                                        <td><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="mas-alc" class="enf_15" name="enferm[]" value="veinteunomasalc"/>
                                        ...
                                        <td><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="Renales" class="enf_16" name="enferm[]" value="renales"/>
                                        ...
                                        <td><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="Sida" class="enf_17" name="enferm[]" value="sida"/>
                                        ...
                                        <td><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="Diabetes" class="enf_18" name="enferm[]" value="diabetes"/>
                                        ...
                                        <td><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="mas6" class="enf_19" name="enferm[]" value="seisveintecig"/>
                                        ...
                                        <td><div class="content_checkboxes">
                                            ...
                                            <input type="checkbox" id="mas6-alc" class="enf_20" name="enferm[]" value="seisveintealc"/>
